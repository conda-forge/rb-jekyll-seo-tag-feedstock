About rb-jekyll-seo-tag-feedstock
=================================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/rb-jekyll-seo-tag-feedstock/blob/main/LICENSE.txt)
...
Once the `conda-forge` channel has been enabled, `rb-jekyll-seo-tag` can be installed with `conda`:
...
```
mamba install rb-jekyll-seo-tag
```

It is possible to list all of the versions of `rb-jekyll-seo-tag` available on your platform with `conda`:
...
```
mamba search rb-jekyll-seo-tag --channel conda-forge
```
...
mamba repoquery search rb-jekyll-seo-tag --channel conda-forge

# List packages depending on `rb-jekyll-seo-tag`:
mamba repoquery whoneeds rb-jekyll-seo-tag --channel conda-forge

# List dependencies of `rb-jekyll-seo-tag`:
mamba repoquery depends rb-jekyll-seo-tag --channel conda-forge
```
